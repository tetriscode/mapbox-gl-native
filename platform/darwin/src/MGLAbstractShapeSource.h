...
/**
 An `NSNumber` object containing a boolean; specifies whether the geoemtry for a
 ...
 Setting this option to `true` slows performance.
  */
...
/**
 ...
 Setting this options to `true` slows performance. Use this option to clip
